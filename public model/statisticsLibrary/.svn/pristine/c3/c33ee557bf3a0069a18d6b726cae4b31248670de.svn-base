 ...
 *
 */
public class StatisticsStartPlayerService 
{
	/**
	 * 实例页面统计服务类对象
	 */
	private static StatisticsStartPlayerService instance = null;
	/**
	 * 头信息BEAN
	 */
	 ...
	 */
	public static StatisticsStartPlayerService getInstance(){
		if (instance == null) {
			instance = new StatisticsStartPlayerService();
		}
		return instance;
	}
	/**
	 * 构造方法
	 */
	private StatisticsStartPlayerService (){
	 ...
	 */
	   ...
	   * @param sessionid
	   */
	  public void transferPlayerMessage(String action, String fid, String duration,String sessionid) {
	...
	private String initXMLData(PlayerMessageArrayBean playerMessageArrayBean) {
		 ...
		 {
			 xml=StringXMLUtil.createStartPlayerXml(playerMessageArrayBean);
		 }
		 return xml;
	}
	/**
