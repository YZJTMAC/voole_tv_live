 ...
 *
 */
public class StatisticsPlayerExceptionService 
{
	/**
	 * 实例页面统计服务类对象
	 */
	private static StatisticsPlayerExceptionService instance = null;
	/**
	 * 头信息BEAN
	 */
	 ...
	 */
	public static StatisticsPlayerExceptionService getInstance(){
		if (instance == null) {
			instance = new StatisticsPlayerExceptionService();
		}
		return instance;
	}
	/**
	 * 构造方法
	 */
	private StatisticsPlayerExceptionService (){
	 ...
	 */
	   ...
	   * @param sessionid
	   */
	  public void transferPlayerMessage(String errcode, String info, String fid,String playtime,String sessionid) {
	...
	private String initXMLData(PlayerMessageArrayBean playerMessageArrayBean) {
		 ...
		 {
			 xml=StringXMLUtil.createPlayerExceptionXml(playerMessageArrayBean);
		 }
		 return xml;
	}
	/**
