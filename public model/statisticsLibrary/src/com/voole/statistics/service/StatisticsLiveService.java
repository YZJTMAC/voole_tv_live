 ...
 *
 */
public class StatisticsLiveService 
{
	/**
	 * 实例页面统计服务类对象
	 */
	private static StatisticsLiveService instance = null;
	/**
	 * 头信息BEAN
	 */
	 ...
	 */
	public static StatisticsLiveService getInstance(){
		if (instance == null) {
			instance = new StatisticsLiveService();
		}
		return instance;
	}
	/**
	...
	private String initXMLData(PlayerMessageArrayBean playerMessageArrayBean) {
		 ...
		 {
			 xml=StringXMLUtil.createPlayerXml(playerMessageArrayBean);
		 }
		 return xml;
	}
	/**
