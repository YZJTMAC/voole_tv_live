...
//		mUrlList = null;
	...
	public void preAuth(String channelCode, String resourceId, String resourceType, String tracker, String bkeUrl, String playUrlVersion, String authInterfaceVersion, String dataType, String proto){
		String mid = "1";
		String sid = "1";
		String fid = "";
		try {
		...
		Ad ad = getPlayUrl(mid, sid, fid, pid, playtype, null, null, null, null, null, null, null, null, null, null, null, null, playUrlVersion, authInterfaceVersion, resourceType, tracker, bkeUrl, dataType, proto, resourceId, "", "", "");
		if(ad!=null && !TextUtils.isEmpty(ad.getPlayUrl())){
			ProxyManager.GetInstance().preUrl(ad.getPlayUrl());
		}
	}
