...
public class StringUtil {
	 ...
	 * @version 1.0
	 * @author LEE
	 * @date 2013-12-13 上午11:09:44 
	 * @update 2013-12-13 上午11:09:44
	 */
	public static float getDownSpeed(String downSpeedStr) {
		float downSpeed = 0;

			// 0.0333KB/s
			downSpeedStr = downSpeedStr.toLowerCase();
			if(downSpeedStr.indexOf("k")>-1) {
				String array[] = downSpeedStr.split("k");
				downSpeed = Float.parseFloat(array[0]);
			} else if(downSpeedStr.indexOf("m")>-1) {
				String array[] = downSpeedStr.split("m");
				downSpeed = Float.parseFloat(array[0]);
				downSpeed = downSpeed*1024;
			} else if(downSpeedStr.indexOf("b")>-1) {
				String array[] = downSpeedStr.split("b");
				downSpeed = Float.parseFloat(array[0]);
				downSpeed = downSpeed/1024;
			} 
