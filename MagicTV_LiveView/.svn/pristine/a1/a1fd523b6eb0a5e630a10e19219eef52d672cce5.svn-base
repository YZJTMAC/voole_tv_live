...
public class AnimUtil {
	...
	public static void setAnim(View view1,float v1,float v2,View view2,float v3,float v4,int duration,final AnimEndEvent event){
		ObjectAnimator objAnimator = ObjectAnimator.ofFloat(view1, "TranslationX", v1,v2).setDuration(duration);
	...
	/*	AnimatorSet aniSet = new AnimatorSet();
		aniSet.play(objAnimator).with(ObjectAnimator.ofFloat(view1, "alpha", 0.5f,1f).setDuration(duration))
			.with(ObjectAnimator.ofFloat(view2, "TranslationX", v3,v4).setDuration(duration))
			.with(ObjectAnimator.ofFloat(view2, "alpha", 0.5f,1f).setDuration(duration));*/
		AnimatorSet aniSet = new AnimatorSet();
		aniSet.play(objAnimator)
			.with(ObjectAnimator.ofFloat(view2, "TranslationX", v3,v4).setDuration(duration));
